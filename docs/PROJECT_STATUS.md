...
当前版本：`0.5.0-compact-under-keyboard-controller`
...
- Arduino Micro 按键下方承托架，底壳高度提高到 24 mm
- Bambu Studio 可导入的 Rev 0.5 STL 导出链路
- Arduino IDE MVP 固件骨架
- 主机端 USB CDC 灯效测试工具

## 尚未验证

- Rev 0.5 外壳与实际轴体、EC11、面板 RGB 灯和 Arduino Micro 的尺寸配合
- 二极管方向和矩阵扫描
