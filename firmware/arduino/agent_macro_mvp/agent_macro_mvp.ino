...
const Action actions[ROW_COUNT][COL_COUNT] = {
  {ACTION_ACCEPT, ACTION_NONE, ACTION_NONE, ACTION_NONE},
  {ACTION_REJECT, ACTION_NEW_CHAT, ACTION_PUSH_TO_TALK, ACTION_FUNCTION_1},
  {ACTION_FUNCTION_2, ACTION_FUNCTION_3, ACTION_FUNCTION_4, ACTION_FUNCTION_5},
  {ACTION_FUNCTION_6, ACTION_FUNCTION_7, ACTION_FUNCTION_8, ACTION_FUNCTION_9},
};
